...
\label{sec:orgbf0d1f0}
\begin{frame}[label={sec:orgb19f5e7},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:org327f840},fragile]{An opinionated tutorial?}
...
\begin{frame}[label={sec:orgd129a4f},fragile]{A word about \texttt{use-package}}
...
\label{sec:org0ba2e82}
\subsection{Code evaluation}
\label{sec:orgb1c2f2c}
\begin{frame}[label={sec:org9accbca},fragile]{Visibility of evaluation}
...
\caption{\label{fig:orgec7ec78}Default patterns for syntactic highlighting.}
\end{figure}
...
\caption{\label{fig:org17108a9}More custom patterns for syntactic highlighting.}
\end{figure}
\end{frame}

\subsection{Parenthesis matching}
\label{sec:org43285e6}
\begin{frame}[label={sec:org332b98a},fragile]{Seeing matching parentheses}
...
\begin{frame}[label={sec:org281bef8},fragile]{Navigating through matching parentheses}
...
\label{sec:org1e36c86}
\begin{frame}[label={sec:org3b7925b},fragile]{Syntax checking: \texttt{Flycheck} vs. \texttt{Flymake}}
...
\label{sec:org6e58a74}
\subsection{company}
\label{sec:orgd045f29}
...
\caption{\label{fig:org0c5184b}An example of code completion with \texttt{company}: various candidates are proposed for the arguments of the function \texttt{car::Anova()}.}
\end{figure}

\texttt{company} offers completion candidates in various contexts: function name, argument name within a function call (as in Fig. \ref{fig:org0c5184b}), object name.
...
\label{sec:orgbcea104}
\begin{frame}[label={sec:org82366e8},fragile]{Code snippets}
...
\begin{frame}[label={sec:org6616305},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
