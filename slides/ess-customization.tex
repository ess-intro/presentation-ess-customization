...
\label{sec:org73d8262}
\begin{frame}[label={sec:orge86ce25},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:org877d1c1},fragile]{A word about \texttt{use-package}}
...
\label{sec:org7b22563}
\begin{frame}[label={sec:orga1af1e7},fragile]{Code snippets}
...
\begin{frame}[label={sec:org5ace551},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
