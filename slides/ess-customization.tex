...
\label{sec:org0058dc7}
\begin{frame}[label={sec:org2a6ea5d},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:orgc085249},fragile]{An opinionated tutorial?}
...
\begin{frame}[label={sec:org7e50b23},fragile]{A word about \texttt{use-package}}
...
\label{sec:org2f2b8ee}
\subsection{Code evaluation}
\label{sec:org1508c65}
\begin{frame}[label={sec:org119cbdf},fragile]{Visibility of evaluation}
...
\caption{\label{fig:org2592515}Default patterns for syntactic highlighting.}
\end{figure}
...
\caption{\label{fig:org842283d}More custom patterns for syntactic highlighting.}
\end{figure}
\end{frame}

\subsection{Parenthesis matching}
\label{sec:orga45133c}
\begin{frame}[label={sec:org5a9e8d3},fragile]{Seeing matching parentheses}
...
\begin{frame}[label={sec:orgf022ff5},fragile]{Navigating through matching parentheses}
...
\label{sec:org0a55f0d}
\begin{frame}[label={sec:org9811fb5},fragile]{Syntax checking: \texttt{Flycheck} vs. \texttt{Flymake}}
...
The following screenshot (Fig. \ref{fig:org938f502}) gives some examples of such checks.
...
\caption{\label{fig:org938f502}An example of syntax errors detected by \texttt{lintr} and displayed in a dedicated \texttt{Flycheck} buffer.}
\end{figure}
\end{frame}
...
\label{sec:org1507591}
\subsection{company}
\label{sec:org65bce91}
...
\caption{\label{fig:org59cb35a}An example of code completion with \texttt{company}: various candidates are proposed for the arguments of the function \texttt{car::Anova()}.}
\end{figure}

\texttt{company} offers completion candidates in various contexts: function name, argument name within a function call (as in Fig. \ref{fig:org59cb35a}), object name.
...
\label{sec:org02c69b6}
\begin{frame}[label={sec:org9896f6a},fragile]{Code snippets}
...
\begin{frame}[label={sec:org711de6d},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
