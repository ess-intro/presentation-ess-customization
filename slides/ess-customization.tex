...
\label{sec:orgdfc6df9}
\begin{frame}[label={sec:org74f9024},fragile]{Code snippets}
...
\begin{frame}[label={sec:org0655526},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
