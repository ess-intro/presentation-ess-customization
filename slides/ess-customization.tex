...
\label{sec:org947c42c}
\begin{frame}[label={sec:org89e0800},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:org55f62b4},fragile]{An opinionated tutorial?}
...
\begin{frame}[label={sec:orgbb6f9e2},fragile]{A word about \texttt{use-package}}
...
\label{sec:org026eff2}
\subsection{Visibility of evaluation}
\label{sec:orgba3c3d2}
\subsection{Window management}
\label{sec:orgc6d9c92}
\subsection{Syntax highlighting}
\label{sec:orgf5c4d5c}
\subsection{Parenthesis matching}
\label{sec:org2ba579b}
\begin{frame}[label={sec:org463e5b7},fragile]{Seeing matching parentheses}
...
\begin{frame}[label={sec:orgb896372},fragile]{Navigating through matching parentheses}
...
\label{sec:org594d252}
\begin{frame}[label={sec:org505cc01},fragile]{Syntax checking: \texttt{Flycheck} vs. \texttt{Flymake}}
...
The following screenshot (Fig. \ref{fig:org5000953}) gives some examples of such checks.
...
\caption{\label{fig:org5000953}An example of syntax errors detected by \texttt{lintr} and displayed in a dedicated \texttt{Flycheck} buffer.}
\end{figure}
\end{frame}

\subsection{Rdired buffers}
\label{sec:org1b7b013}

\section{Some useful Emacs packages}
\label{sec:orgb5a206b}
\subsection{company}
\label{sec:org8a367e5}
...
\caption{\label{fig:org3485926}An example of code completion with \texttt{company}: various candidates are proposed for the arguments of the function \texttt{car::Anova()}.}
\end{figure}

\texttt{company} offers completion candidates in various contexts: function name, argument name within a function call (as in Fig. \ref{fig:org3485926}), object name.
...
\label{sec:org2a31c47}
\begin{frame}[label={sec:orge0e47a0},fragile]{Code snippets}
...
\begin{frame}[label={sec:orgc6b9342},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
