...
\label{sec:orgfe005e5}
\begin{frame}[label={sec:org89891fd},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:orgf54bcba},fragile]{A word about \texttt{use-package}}
...
\label{sec:orgd7c7a29}
\begin{frame}[label={sec:org7ba2ac6},fragile]{Code snippets}
...
\begin{frame}[label={sec:orgfd9f44a},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
