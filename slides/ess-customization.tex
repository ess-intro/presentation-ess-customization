...
\label{sec:org3b42bc0}
\begin{frame}[label={sec:orge98e598},fragile]{A short tutorial for customizing ESS}
...
\begin{frame}[label={sec:org5b099b1},fragile]{An opinionated tutorial?}
...
\begin{frame}[label={sec:org6254f3a},fragile]{A word about \texttt{use-package}}
...
\label{sec:org6aaa246}
\subsection{Code evaluation}
\label{sec:orgd8d5ba4}
\begin{frame}[label={sec:org1ff641b},fragile]{Visibility of evaluation}
...
\label{sec:org4933471}
\subsection{Syntax highlighting}
\label{sec:org523f512}
...
\caption{\label{fig:orgb279be2}Default patterns for syntactic highlighting.}
\end{figure}
...
\caption{\label{fig:orgee05d23}More custom patterns for syntactic highlighting.}
\end{figure}
\end{frame}

\subsection{Parenthesis matching}
\label{sec:org360c7c7}
\begin{frame}[label={sec:orgac5c0cd},fragile]{Seeing matching parentheses}
...
\begin{frame}[label={sec:org33618a5},fragile]{Navigating through matching parentheses}
...
\label{sec:orgdc6dd93}
\begin{frame}[label={sec:org446661b},fragile]{Syntax checking: \texttt{Flycheck} vs. \texttt{Flymake}}
...
The following screenshot (Fig. \ref{fig:org88d127a}) gives some examples of such checks.
...
\caption{\label{fig:org88d127a}An example of syntax errors detected by \texttt{lintr} and displayed in a dedicated \texttt{Flycheck} buffer.}
\end{figure}
\end{frame}

\subsection{Rdired buffers}
\label{sec:orgd018203}

\section{Some useful Emacs packages}
\label{sec:orgbe8d82c}
\subsection{company}
\label{sec:orge6835b3}
...
\caption{\label{fig:orga2f4fad}An example of code completion with \texttt{company}: various candidates are proposed for the arguments of the function \texttt{car::Anova()}.}
\end{figure}

\texttt{company} offers completion candidates in various contexts: function name, argument name within a function call (as in Fig. \ref{fig:orga2f4fad}), object name.
...
\label{sec:org086ac26}
\begin{frame}[label={sec:org69122dd},fragile]{Code snippets}
...
\begin{frame}[label={sec:org7f1491b},fragile]{Using \texttt{yasnippet} in an ESS[R] buffer}
